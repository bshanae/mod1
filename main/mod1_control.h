...
#define MOD1_LIGHT_POINT_POSITION			200, 10000, 200
...
#define MOD1_BACKGROUND						mod1_point3<float>(0.8)
...
#define MOD1_TERRAIN_NOISE_HILL_OFFSET		mod1_point2<float>(0)
