...
{
	cl_arg_const_flow = cl_kernel_update_flow.generate_argument(
...
{
	cl_arg_size = cl_kernel_update_flow.generate_argument(
...
{
	cl_arg_terrain_data = cl_kernel_update_flow.generate_argument(
...
{
	cl_arg_water_data = cl_kernel_update_flow.generate_argument(
...
{
	cl_arg_flow_horizontal = cl_kernel_update_flow.generate_argument(
		empty_data.data(), empty_data.size_in_bytes(),
		mod1_engine_cl::argument_type::read_write, false);
	cl_arg_flow_vertical = cl_kernel_update_flow.generate_argument(
		empty_data.data(), empty_data.size_in_bytes(),
		mod1_engine_cl::argument_type::read_write, false);
}