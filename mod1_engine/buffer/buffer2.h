...
public :
	...
	MOD1_GENERATE_EXCEPTION(exception_allocation, "Mod1 Engine, Buffer2 : Buffer isn't allocated")
	MOD1_GENERATE_EXCEPTION(exception_logic_a, "Mod1 Engine, Buffer2 : Buffer shouldn't be allocated more than once")
	MOD1_GENERATE_EXCEPTION(exception_logic_b, "Mod1 Engine, Buffer2 : Source buffer has different size")
	MOD1_GENERATE_EXCEPTION(exception_size, "Mod1 Engine, Buffer2 : Bad size")
	MOD1_GENERATE_EXCEPTION(exception_index, "Mod1 Engine, Buffer2 : Bad index")
...
private :
	...
	buffer<buffer<type>>	data_internal;
	int								size_internal = 0;
};