...
public :
	...
	MOD1_GENERATE_EXCEPTION_DEFINITION(exception_coordinate, "Mod1 Algorithm, Plane : Bad coordinate")
	MOD1_GENERATE_EXCEPTION_DEFINITION(exception_logic, "Mod1 Algorithm, Plane : Object not set")
	MOD1_GENERATE_EXCEPTION_DEFINITION(exception_color, "Mod1 Algorithm, Plane : Too few colors defined")
	MOD1_GENERATE_EXCEPTION_DEFINITION(exception_indexing_convention, "Mod1 Algorithm, Plane : Unknown indexing convention")
