						...
						const int &index_c)
{
	...
	ptr_a = (float *)model::get_ptr(index_a, mod1_engine::model_data::slot_point);
	ptr_b = (float *)model::get_ptr(index_b, mod1_engine::model_data::slot_point);
	ptr_c = (float *)model::get_ptr(index_c, mod1_engine::model_data::slot_point);
	...
	ptr_n = (float *)model::get_ptr(index_a, mod1_engine::model_data::slot_normal);
